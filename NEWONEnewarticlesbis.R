...
txt1<-list.load("dataharvestingNEWbis.RData")

txt <- c(txt, txt1, txt1, txt1, txt1, txt1, txt1, txt1, txt1, txt1, txt1, txt1, txt1, txt1, txt1, txt1, txt1, txt1, txt1, txt1, txt1, txt1, txt1, txt1, txt1, txt1, txt1, txt1, txt1, txt1, txt1, txt1, txt1, txt1, txt1, txt1, txt1, txt1, txt1, txt1, txt1)
...
setwd("..")
save(dtm, file="finaldtmnewbis.Rdata")
load("finaldtmnewbis.Rdata")
save(myCorp, file = "finalcorpusnewbis.Rdata")
load("finalcorpusnewbis.Rdata")
####some statistic
...
save(ap_lda1, file = "ldamodelnewbis.Rdata")



ap_lda19 <- LDA(dtm, 19, method = "Gibbs",control = list(iter = 100, seed = 33))

save(ap_lda19, file = "ldamodel19.Rdata")

serVis(topicmodels2LDAvis(ap_lda1),  out.dir = 'visnew')


ap_lda30 <- LDA(dtm, 30, method = "Gibbs",control = list(iter = 100, seed = 33))

save(ap_lda30, file = "ldamodel30.Rdata")

serVis(topicmodels2LDAvis(ap_lda19),  out.dir = 'vis30')

ap_lda100 <- LDA(dtm, 100, method = "Gibbs",control = list(iter = 100, seed = 33))

save(ap_lda100, file = "ldamodel100new.Rdata")

serVis(topicmodels2LDAvis(ap_lda100),  out.dir = 'vis100')
...
serVis(topicmodels2LDAvis(ap_lda1),  out.dir = 'visnewbis')
